        ...
        <View style={styles.heroImageSection}>
          ...
          <View style={styles.motivationalSection}>
            <Image
              contentFit="fill"
              source={referAndEarn}
              style={styles.agentLevelsImage}
            />
            <Image
              contentFit="contain"
              source={referalLevel}
              style={[styles.agentLevelsImage, { bottom: 10 }]}
            />
            <Image
              contentFit="contain"
              source={inviteFriends}
              style={[styles.agentLevelsImage, { marginTop: Scale(10) }]}
            />
            <Image
              contentFit="contain"
              source={earnCommissions}
              style={[styles.agentLevelsImage, { marginTop: Scale(20) }]}
            />
            <Image
              contentFit="contain"
              source={commissionRules}
              style={[styles.agentLevelsImage, { marginTop: Scale(20) }]}
            />
          </View>
          ...
          <View style={styles.motivationalSection}>
            ...
            <Image
              contentFit="fill"
              source={threeDigitCommissionRate}
              style={[styles.agentLevelsImage, { marginTop: Scale(10) }]}
            />
            <Image
              contentFit="fill"
              source={casionCommissionRate}
              style={[styles.agentLevelsImage, { marginTop: Scale(10) }]}
            />
            <Image
              contentFit="fill"
              source={colorCommissionRate}
              style={[styles.agentLevelsImage, { marginTop: Scale(20) }]}
            />
          </View>
