  ...
  return (
    <>
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        <Image source={lotteryHeader} style={{ width: 150, height: 50 }} resizeMode='contain' />
        ...
        <FlatList data={lotteryGamesList}
          ...
          renderItem={({ item }) => {
            return (
              <View >
                <Image source={item.image} style={{ width: Scale(100), height: Scale(100) }} resizeMode='contain' />
              </View>
            )
          }
          } />
      ...
      <View style={{
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: "center", marginTop: Scale(10) }}>
          <Image source={chipIcon} style={{ width: Scale(25), height: Scale(25) }} resizeMode='contain' />
