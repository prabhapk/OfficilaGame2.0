...
const WalletScreenUI = ({ navigation }: any) => {
  ...
  const [selectedRechargeOption, setSelectedRechargeOption] = useState<
        ...
        <View style={styles.rechargeSection}>
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              {
                borderColor:
                  selectedRechargeOption === "option1" ? COLORS.white : "grey",
              },
            ]}
          >
            <View style={styles.optionContent}>
              <Image
                source={{
                  uri: "https://upload.wikimedia.org/wikipedia/commons/4/4e/Paytm_Logo.png",
                }}
                style={styles.paytmLogo}
                contentFit="contain"
              />
              <Text style={styles.bankText}>
                {paymentGateWayLists[0]?.gateway}
              </Text>
            </View>
      ...
      />
        ...
        <View style={styles.redWarningBox}>
          <Text style={styles.redWarningText}>
            Due to the normal risk alerts caused by bank control, please feel
            free to recharge.{"\n"}
            <Text style={styles.redWarningText}>
              If the funds are not received in time, please contact the online
