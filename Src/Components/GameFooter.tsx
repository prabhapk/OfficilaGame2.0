  ...
  return (
    ...
    style ={{flexDirection: 'row', marginHorizontal: Scale(10),}}>
      ...
      <View style ={{marginHorizontal: Scale(10)}}>
        <Text style ={{fontSize: Scale(20), fontWeight: 'bold', color: '#fff' }}>$ {totalAmount}</Text>
        <Text style={{fontSize:Scale(14), color: '#fff'}}>{totalCount} numbers</Text>
      </View>
    </TouchableOpacity>
    <TouchableOpacity
style={{margunRight:10}}
    disabled={isDisabled}
    >
        <LinearGradient
