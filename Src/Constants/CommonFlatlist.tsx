import { bhutan, casinMenu, casino, casinoActiveTab, casinoTab, CasionoGamesIcon, color, dice, digit, digitMenu, dragonvsTiger, DrawerPromotion, DrawerRebate, DrawerSuperAgent, fiveMin3DImage, homeActiveIcon, homeNewIcon, homeNewIconSilver, homeTab, hot, hotGamesIcon, inviteActiveTab, inviteNewIcon, inviteTab, jdb, Jili, lottery1, LotteryGamesIcon, meActiveIcon, meNewIcon, meTab, multiUserIcon, oneMin3DImage, pg, profileCustomerServiceImage, promotionActiveIcon, promotionNewIcon, promotions, quick1, quick2, quick3, quick3d1min, quick3d3min, quick3d5min, quick3dMenu, quick3min, resultActiveIcon, resultActiveTab, resultNewIcon, resultTab, rummy, scratch, scratchMenu, sevenUpAndDown, sportMenu, sports, teenPatti, threeMin3DImage, threePatti } from "../../assets/assets";
